    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    enumfields.fields.EnumField(
                        default="CONCERT", enum=event.models.EventType, max_length=20, verbose_name="이벤트 타입"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    enumfields.fields.EnumField(
                        default="READY", enum=event.models.TicketState, max_length=20, verbose_name="티켓 상태"
                    ),
                ),
                (
                    "event",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="event.event", verbose_name="공연/경기 ID"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "inventory",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="event.ticketinventory"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    enumfields.fields.EnumField(
                        default="NOT_USED", enum=event.models.UserTicketState, max_length=20, verbose_name="티켓 상태"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_ticket",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="event.userticket", verbose_name="유저 티켓"
                    ),
                ),
            ],
            options={
