...
from event.views import event_views, ticket_purchase_views, ticket_views
...
urlpatterns = [
    ...
    path(
        "<int:event_id>/tickets/<int:ticket_id>/purchase/",
        ticket_purchase_views.TicketPurchaseView.as_view(),
